    ...
    <section class="flex h-screen justify-center items-center bg-gray-200/50 dark:bg-secondary">
        <div class="bg-white dark:bg-gray-800 p-5 max-w-xl mx-auto rounded-md">
            ...
            <form @submit.prevent="registerSubmit" class="mt-10 space-y-8">
                <input v-model="email" class="w-full border rounded h-12 px-4 focus:outline-none"
                    placeholder="Adresse email" type="email" />

                <div class="flex items-center">
                    <input v-model="username" class="w-full border rounded h-12 px-4 focus:outline-none -mr-7"
                        placeholder="Nom d'utilisateur" type="text" />
                </div>

                <div class="flex items-center">
                    <input v-model="password" class="w-full border rounded h-12 px-4 focus:outline-none -mr-7"
...
export default {
    ...
    methods: {
        /**
         * @description Permet de créer un utilisateur à l'envoi du formulaire
         */
